...
module Backend.ParGrammar where
import Backend.AbsGrammar
import Backend.LexGrammar
import Backend.ErrM
...
happyReduction_10 happy_x_1
	...
	happyIn13
		 (Backend.AbsGrammar.Prog happy_var_1
	)}
...
happyReduction_11 happy_x_3
	...
	happyIn14
		 (Backend.AbsGrammar.SAss happy_var_1 happy_var_3
	)}}
...
happyReduction_12 happy_x_1
	...
	happyIn14
		 (Backend.AbsGrammar.SExp happy_var_1
	)}
...
happyReduction_16 happy_x_3
	...
	happyIn16
		 (Backend.AbsGrammar.ExpAdd happy_var_1 happy_var_3
	)}}
...
happyReduction_18 happy_x_3
	...
	happyIn17
		 (Backend.AbsGrammar.ExpSub happy_var_1 happy_var_3
	)}}
...
happyReduction_20 happy_x_3
	...
	happyIn18
		 (Backend.AbsGrammar.ExpMul happy_var_1 happy_var_3
	)}}
...
happyReduction_21 happy_x_3
	...
	case happyOut19 happy_x_3 of { happy_var_3 ->
	happyIn18
		 (Backend.AbsGrammar.ExpDiv happy_var_1 happy_var_3
	)}}
...
happyReduction_23 happy_x_1
	...
	happyIn19
		 (Backend.AbsGrammar.ExpLit happy_var_1
	)}
...
happyReduction_24 happy_x_1
	 =  case happyOut11 happy_x_1 of { happy_var_1 ->
	happyIn19
		 (Backend.AbsGrammar.ExpVar happy_var_1
	)}
